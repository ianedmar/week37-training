...
for (let index = max; index > 0; index--) {
    ...
    if (index - 1 === 0) {
        console.log("Take one down, pass it around, no more bottles of soda on the shelf");
    } else {
...
const pi = 3.14159;    // pi
let numberOfPeople = 10; // Number of people in a room (this can vary)
...
const phoneNumbers = ["112", "113", "110", "40322107"];
